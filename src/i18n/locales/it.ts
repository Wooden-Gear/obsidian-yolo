...
export const it: TranslationKeys = {
  ...
  settings: {
    ...
    providers: {
      ...
      pickerSubtitle: 'Seleziona un provider per continuare la configurazione',
      pickerSearchPlaceholder: 'Cerca · nome / protocollo / descrizione',
      ...
      pickerEmptyHint: 'Seleziona un provider per continuare',
      pickerSelected: 'Selezionato',
      pickerSelectedTail: ', il passo successivo aprirà la finestra di configurazione',
      pickerNext: 'Avanti →',
      categoryAll: 'Tutti',
      categoryMain: 'Internazionali',
      categoryCn: 'Cina',
