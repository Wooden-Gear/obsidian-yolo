...
export const en: TranslationKeys = {
  ...
  settings: {
    ...
    providers: {
      ...
      pickerSubtitle: 'Pick a provider to continue configuration',
      pickerSearchPlaceholder: 'Search providers · name / protocol / description',
      pickerCustomLabel: 'Custom provider',
      pickerCustomDesc: 'Manually enter base URL and API key',
      pickerEmpty: 'No matching providers',
      pickerEmptyHint: 'Pick a provider to continue',
      pickerSelected: 'Selected',
      pickerSelectedTail: ', next opens the configuration dialog',
      pickerNext: 'Next →',
      categoryAll: 'All',
