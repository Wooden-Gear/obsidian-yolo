...
export const zh: TranslationKeys = {
  ...
  settings: {
    ...
    systemPrompt: {
      title: '全局系统提示词',
      desc: '管理模块化系统提示词，可以组织和重用不同的提示词组件',
      modularMode: '模块化模式',
      previewMode: '预览模式',
      addGroup: '添加提示词分组',
      addPrompt: '添加提示词',
      defaultGroupName: '新分组',
      defaultPromptName: '新提示词',
      defaultPromptContent: '请输入提示词内容...',
      groupNamePlaceholder: '分组名称',
      promptNamePlaceholder: '提示词名称',
      promptContentPlaceholder: '输入提示词内容...',
      editPrompt: '编辑提示词',
      editGroupName: '点击编辑分组名称',
      editPromptName: '点击编辑提示词名称',
      editPromptContent: '输入提示词内容进行编辑...',
      editingTips: '编辑提示',
      tip1: 'Ctrl/Cmd + S: 保存',
      tip2: 'Ctrl/Cmd + Enter: 保存并关闭',
      tip3: 'Esc: 取消并关闭',
      tip4: '支持多行文本和格式化内容',
      wordCount: '字数',
      charCount: '字符数',
      reset: '重置',
      confirmResetContent: '确定要重置为原始内容吗？',
      confirmDiscardChanges: '确定要放弃当前更改吗？',
      confirmDeleteGroup: '确定要删除此分组及其包含的所有提示词吗？',
    ...
    systemPreview: {
      title: '预览模式',
      previewContent: '系统提示词预览',
      previewDesc: '这是按顺序组合所有启用的提示词模块后的最终内容',
      previewEmpty: '没有启用的提示词模块',
      copyToClipboard: '复制到剪贴板',
      copied: '已复制',
      previewTip: '提示：此内容将作为系统提示词发送给AI模型',
      totalChars: '总字符数',
      totalWords: '总词数',
      totalLines: '总行数',
      chineseChars: '中文',
  ...
  chat: {
    ...
    systemPrompt: {
      toggleTitle: '管理系统提示词',
      toggleAria: '打开系统提示词设置',
      title: '系统提示词',
      description: '管理当前对话使用的系统提示词模块',
      empty: '暂无系统提示词',
      hasChanges: '有未保存的更改',
      applyChanges: '应用更改',
      discardChanges: '放弃更改',
