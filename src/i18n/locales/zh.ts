...
export const zh: TranslationKeys = {
  ...
  settings: {
    ...
    rag: {
      ...
      pgliteVerifyIntegrity: '校验完整性',
      pgliteVerifyingIntegrity: '校验中…',
      pgliteIntegrityOk: 'PGlite 运行时完整性校验通过。',
      pgliteIntegrityFailed: '完整性校验失败',
      pgliteIntegrityFailedHint: '请重新下载运行时资源。',
      pgliteRecheck: '重新检查',
