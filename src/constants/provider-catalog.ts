...
export type ProviderCatalogEntry = {
  ...
  /** Short hint shown under the provider name (mono font in design). */
  kindKey: string
  /** Localised default fallback for `kindKey` when no translation registered. */
  kindFallback: string
...
> = {
  openai: {
    ...
    category: 'main',
    kindKey: 'openai',
    kindFallback: 'Reasoning · Multimodal',
    logo: openaiLogo,
  },
  'chatgpt-oauth': {
    monogram: 'GPT',
    tint: 'green',
    category: 'main',
    kindKey: 'chatgptOAuth',
    kindFallback: 'ChatGPT Plus / Pro',
    oauth: true,
    logo: openaiLogo,
  },
  anthropic: {
  ...
  perplexity: {
    ...
    category: 'main',
    kindKey: 'perplexity',
    kindFallback: 'Search-augmented chat',
    logo: perplexityLogo,
  },
  groq: {
    monogram: 'Gq',
